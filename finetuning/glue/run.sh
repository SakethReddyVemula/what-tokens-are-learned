...
#SBATCH --output=glue-finetuning.out
#SBATCH --error=glue-finetuning.err
...
export WANDB_PROJECT="p3-glue-finetuning"
...
JOB_NAME="glue_${TASK_NAME}_${LANG}_${MODEL_TYPE}_${VOCAB_SIZE}"
if [ "$MODEL_TYPE" == "superbpe" ]; then
    JOB_NAME="glue_${TASK_NAME}_${LANG}_${MODEL_TYPE}_${SUPERBPE_BASE_VOCAB_SIZE}_${VOCAB_SIZE}"
fi
