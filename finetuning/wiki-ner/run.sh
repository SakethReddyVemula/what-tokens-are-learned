#!/bin/bash
#SBATCH --job-name=wiki-ner
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --gres=gpu:1
#SBATCH --mem-per-cpu=2048
#SBATCH --time=1-00:00:00
#SBATCH --output=wiki-ner-finetuning.out
#SBATCH --error=wiki-ner-finetuning.err
...
export WANDB_PROJECT="p3-wiki-ner-finetuning"
...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        --dataset_config) DATASET_CONFIG="$2"; shift ;;
        *) echo "Unknown parameter passed: $1"; exit 1 ;;
    esac
    shift
done

JOB_NAME="wikiner_${LANG}_${MODEL_TYPE}_${VOCAB_SIZE}"
if [ "$MODEL_TYPE" == "superbpe" ]; then
    JOB_NAME="wikiner_${LANG}_${MODEL_TYPE}_${SUPERBPE_BASE_VOCAB_SIZE}_${VOCAB_SIZE}"
fi
