#!/bin/bash
#SBATCH --job-name=iitp-pr
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --gres=gpu:1
#SBATCH --mem-per-cpu=2048
#SBATCH --time=1-00:00:00
#SBATCH --output=iitp-pr-finetuning.out
#SBATCH --error=iitp-pr-finetuning.err
...
export WANDB_PROJECT="p3-iitp-pr-finetuning"
...
JOB_NAME="iitp_${LANG}_${MODEL_TYPE}_${VOCAB_SIZE}"
if [ "$MODEL_TYPE" == "superbpe" ]; then
    JOB_NAME="iitp_${LANG}_${MODEL_TYPE}_${SUPERBPE_BASE_VOCAB_SIZE}_${VOCAB_SIZE}"
fi
