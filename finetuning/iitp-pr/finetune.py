...
class FinetuneArguments:
    language: str = field(default="hi", metadata={"help": "Language code (e.g., hi)"})
...
def main():
    ...
    if training_args.local_rank == 0 and "wandb" in training_args.report_to:
        wandb.init(
            project=os.environ.get("WANDB_PROJECT", "p3-iitp-pr-finetuning"),
            name=f"iitp-pr_{args.language}_{'bpe-dropout' if args.bpe_dropout else args.model_type}_v{args.vocab_size}",
    ...
    dataset = load_dataset("ai4bharat/indic_glue", "iitp-pr.hi")
