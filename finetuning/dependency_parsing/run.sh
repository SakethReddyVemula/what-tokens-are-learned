...
#SBATCH --output=dp-finetuning.out
#SBATCH --error=dp-finetuning.err
...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        --max_steps) MAX_STEPS="--max_steps $2"; shift ;;
        *) echo "Unknown parameter passed: $1"; exit 1 ;;
    esac
    shift
done

JOB_NAME="deps_${LANG}_${MODEL_TYPE}_${VOCAB_SIZE}"
if [ "$MODEL_TYPE" == "superbpe" ]; then
    JOB_NAME="deps_${LANG}_${MODEL_TYPE}_${SUPERBPE_BASE_VOCAB_SIZE}_${VOCAB_SIZE}"
fi
