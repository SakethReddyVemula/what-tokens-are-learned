...
#SBATCH --output=pos-finetuning.out
#SBATCH --error=pos-finetuning.err
...
JOB_NAME="pos_${LANG}_${DATASET_CONFIG}_${MODEL_TYPE}_${VOCAB_SIZE}_seed${SEED}"
if [ "$MODEL_TYPE" == "superbpe" ]; then
    JOB_NAME="pos_${LANG}_${DATASET_CONFIG}_${MODEL_TYPE}_${SUPERBPE_BASE_VOCAB_SIZE}_${VOCAB_SIZE}_seed${SEED}"
fi
