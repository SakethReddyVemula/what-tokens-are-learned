#!/bin/bash
#SBATCH --job-name=bpedropout-eng
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --gres=gpu:4
#SBATCH --mem-per-cpu=2048
#SBATCH --time=2-00:00:00
#SBATCH --output=eng-bert-pretraining.out
#SBATCH --error=eng-bert-pretraining.err
...
# Parse arguments
LANG="eng"
MODEL_TYPE="bpe-dropout" # options: bpe, unigram, wordpiece, sage, bpe-dropout, pathpiece, pickybpe, boundlessbpe, superbpe
VOCAB_SIZE=10000
...
# APIs & Tokens
export WANDB_PROJECT="bert-pretraining-p3-8M"
