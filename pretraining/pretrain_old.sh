#!/bin/bash
#SBATCH --job-name=bpe-eng
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --gres=gpu:2
#SBATCH --mem-per-cpu=2048
#SBATCH --time=2-00:00:00
#SBATCH --output=bert-pretraining.out
#SBATCH --error=bert-pretraining.err
...
# Parse arguments
LANG="eng"
MODEL_TYPE="superbpe" # options: bpe, unigram, wordpiece, sage, bpe-dropout, pathpiece, pickybpe, boundlessbpe, superbpe
VOCAB_SIZE=10000
...
# APIs & Tokens
export WANDB_PROJECT="bert-pretraining-p3"
...
torchrun \
    ...
    --data_path /scratch/saketh_vemula/data/${LANG}/train.${LANG} \
