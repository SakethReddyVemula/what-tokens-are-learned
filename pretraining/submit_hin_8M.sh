...
LANGUAGES=("hin")  # Add or remove languages as needed
# MODEL_TYPES=("bpe" "unigram" "wordpiece" "sage" "bpe-dropout" "pathpiece" "pickybpe" "boundlessbpe" "superbpe")
# MODEL_TYPES=("bpe" "sslm-bpe" "unigram" "sage" "pickybpe" "boundlessbpe" "superbpe")
MODEL_TYPES=("superbpe")
VOCAB_SIZE=10000
