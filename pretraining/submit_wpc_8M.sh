#!/bin/bash
#SBATCH --job-name=wpc-berts
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --gres=gpu:2
#SBATCH --mem-per-cpu=2048
#SBATCH --time=3-00:00:00
#SBATCH --output=wpc-bert-pretraining.out
#SBATCH --error=wpc-bert-pretraining.err
#SBATCH --mail-user=saketh.vemula@research.iiit.ac.in
#SBATCH --mail-type=ALL
#SBATCH --nodelist=gnode087
...
LANGUAGES=("eng" "hin" "tel")  # Add or remove languages as needed
MODEL_TYPES=("wordpiece")
# MODEL_TYPES=("pickybpe" "boundlessbpe" "superbpe" "sslm-ulm")
VOCAB_SIZE=10000
